...
export default function Dashboard() {
    ...
    const [pieChartSeries] = useState([Math.floor(verticalBarChartSeries[0].data[0] / verticalBarChartSeries[0].data.reduce((x, y) => x + y) * 100)])
    return (
        <div className='h-screen'>
            ...
            <div className="flex justify-between w-full mt-16">
                <div className='basis-[45%] bg-white h-80 rounded-lg p-5'>
